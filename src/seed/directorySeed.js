...
// Clean seed module exported for DataContext usage.
  ...
  Faculty: {
    ...
    { ADM_ID: 'ADM-002', first_name: 'Michael', last_name: 'Turner' }
  ],
    ABAs: [
...
const seededParents = raw.Parents.map((p) => ({
  ...
  phone: null,
// Seed data was migrated to `directorySeed_v2.js` to fix syntax/formatting issues.
// Keep this file as a thin re-export so any imports of `directorySeed.js`
// continue to work while the canonical data lives in the v2 module.

export { seededParents, seededTherapists, seededChildrenWithParents } from './directorySeed_v2';