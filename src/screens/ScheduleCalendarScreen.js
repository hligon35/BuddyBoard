...
const styles = StyleSheet.create({
  ...
  parentCancelButton: { minHeight: 36, borderRadius: 18, backgroundColor: '#fee2e2', paddingHorizontal: 14, alignItems: 'center', justifyContent: 'center', marginTop: 2, marginBottom: 10 },
  parentCancelButtonCompact: { minHeight: 36, borderRadius: 18, backgroundColor: '#fee2e2', paddingHorizontal: 12, alignItems: 'center', justifyContent: 'center', marginTop: 2 },
